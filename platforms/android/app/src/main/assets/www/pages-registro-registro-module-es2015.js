    ...
    registrar_usuario(fRegistroUsuario) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (fRegistroUsuario.invalid)
                ...
                const valido = yield this.service.registro_cliente(this.registerUser.name, this.registerUser.email, this.registerUser.password, this.registerUser.avatar);
                if (valido)
    ...
    registrar_empresa(fRegistroEmpresa) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (fRegistroEmpresa.invalid)
                ...
                const valido = yield this.service.registro_empresa(this.registerEmpresa.name, this.registerEmpresa.email, this.registerEmpresa.password);
                if (valido)
                    this.route.navigate(['/home-cliente']);
                else
                    this.presentToast();
    ...
    login(fLogin) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (fLogin.invalid)
                ...
                const valido = yield this.service.login(this.loginUser.email, this.loginUser.password);
                if (valido)
                    this.route.navigate(['/home-cliente']);
                else
                    this.presentToast();
...
let ServiceService = class ServiceService {
    ...
    registro_cliente(name, email, password, avatar) {
    ...
    registro_empresa(name, email, password) {

...
var CreateProductPageRoutingModule = /** @class */ (function () {
    function CreateProductPageRoutingModule() {
    }
...
var CreateProductPage = /** @class */ (function () {
    function CreateProductPage(service, crud, router, activatedRoute, toastController) {
    ...
    CreateProductPage.prototype.ngOnInit = function () {
        var _this = this;
        var params = this.activatedRoute.snapshot.params;
        if (params.id) {
            this.crud.getProducto(params.id)
                .subscribe(function (res) {
                _this.producto = res[0];
                _this.edit = true;
            }, function (err) { return console.log(err); });
        }
    };
    CreateProductPage.prototype.presentToast = function (mensaje) {
    ...
    CreateProductPage.prototype.saveProduct = function (name, price, amount) {
        var _this = this;
        this.service.addProduct(name.value, price.value, amount.value).then(function (resp) {
            _this.presentToast(resp["Response:"]);
            _this.router.navigate(['/lista_productos']);
        });
    };
    CreateProductPage.prototype.updateProducto = function (name, price, amount) {
        var _this = this;
    ...
    CreateProductPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-create-product-create-product-module-es5.js.map
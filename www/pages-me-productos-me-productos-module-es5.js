...
var MeProductosPageRoutingModule = /** @class */ (function () {
    function MeProductosPageRoutingModule() {
    }
    ...
    return MeProductosPageRoutingModule;
}());
...
var MeProductosPageModule = /** @class */ (function () {
    function MeProductosPageModule() {
    }
...
var MeProductosPage = /** @class */ (function () {
    function MeProductosPage(crud, toastController, router) {
        this.crud = crud;
        this.toastController = toastController;
        this.router = router;
        this.productos = [];
    }
    MeProductosPage.prototype.ngOnInit = function () {
        this.getProductos();
    };
    MeProductosPage.prototype.ionViewWillEnter = function () {
        this.getProductos();
    };
    MeProductosPage.prototype.presentToast = function (mensaje) {
    ...
    MeProductosPage.prototype.getProductos = function () {
        var _this = this;
        this.crud.listarProducto().then(function (productos) {
            _this.productos = productos;
        });
    };
    MeProductosPage.prototype.deleteProducto = function (id) {
        var _this = this;
        this.crud.deleteProducto(id)
            .subscribe(function (res) {
            _this.getProductos();
        }, function (err) { return _this.presentToast("Error al eliminar el producto"); });
    };
    MeProductosPage.prototype.addProduct = function () {
        this.router.navigate(['/create-product']);
    };
    MeProductosPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-me-productos-me-productos-module-es5.js.map